...
export const AddTask: React.FC<AddTaskProps> = ({ onClose, onSuccess, task, initialValues }) => {
    const { projects, addTask, updateTask, colorScheme, theme, language, t } = useApp();
        ...
        >
            ...
            <View style={[styles.header, { paddingHorizontal: pagePadding }]}>
                <TouchableOpacity style={styles.headerButton} onPress={onClose} activeOpacity={0.8}>
                    <Ionicons name="chevron-back" size={30} color={theme.blue} />
                </TouchableOpacity>
                        ...
                        <Controller
                            ...
                            render={({ field: { onChange, onBlur, value } }) => (
                                <View style={[styles.inputBox, styles.textAreaBox, errors.description && styles.inputBoxError]}>
                                    <Ionicons name="list-outline" size={24} color={theme.blue} style={styles.textAreaIcon} />
                                    <TextInput
                        ...
                        <Controller
                            ...
                            render={({ field: { value } }) => (
                                ...
                                >
                                    ...
                                    <Ionicons name="chevron-down" size={24} color={theme.blue} />
                                </TouchableOpacity>
                            )}
                        />
                        ...
                        <Controller
                            ...
                            render={({ field: { value } }) => (
                                <TouchableOpacity
                                    ...
                                    activeOpacity={0.82}
                                >
                                    <Ionicons name="time-outline" size={24} color={theme.blue} />
                                    <Text style={[styles.selectText, !value && styles.placeholderText]}>
            ...
            <Modal visible={showDateModal} animationType="fade" onRequestClose={() => setShowDateModal(false)}>
                <TouchableOpacity style={styles.modalOverlay} activeOpacity={1} onPress={() => setShowDateModal(false)}>
                    <View style={styles.pickerCard} onStartShouldSetResponder={() => true}>
                        <View style={styles.pickerHeader}>
                            ...
                            <TouchableOpacity style={styles.pickerArrow} onPress={() => shiftMonth(1)}>
                                <Ionicons name="chevron-forward" size={22} color={theme.blue} />
                            </TouchableOpacity>
                        </View>
            ...
            <Modal visible={showTimeModal} animationType="fade" onRequestClose={() => setShowTimeModal(false)}>
